...
import { updateCompany, State } from "@/query/companies/actions";
import { useActionState, useTransition } from "react";

export default function EditForm({ closeModal, company }: { closeModal: () => void, company: Company }) {
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
            <div className="px-2 pr-14">
                ...
                <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                    Update your details to keep company up-to-date.
                </p>
            </div>
                    ...
                    <div className="mt-7">
                        ...
                        <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                            <div className="col-span-2 lg:col-span-1">
                                ...
                                <Input id="name" name="name" type="text" defaultValue={company.name} />
                            </div>
